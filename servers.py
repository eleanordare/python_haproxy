...
class serverMethods():
    ...
    def checkIfExisting(frontendsFile, backendsFile, server):
    ...
    def addServer(frontendsFile, backendsFile, server):
    ...
    def removeServer(frontendsFile, backendsFile, server):
    ...
    def changeServer(frontendsFile, backendsFile, server1, server2):
